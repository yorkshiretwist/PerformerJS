...
var Performer =
{
	...
	Debug: function(str, status)
	{
	    if (Performer.Debugging)
	    {
	        ...
	        {
			document.getElementsByTagName('body')[0].innerHTML += '<div style="background:#333;position:fixed;bottom:0;right:0;left:0;"><h3 style="font-family:Arial,sans-serif;padding:0.3em;margin:0;color:#FFF;">Performer Debug Output</h3><div id="performerjsoutput" style="padding:0.3em;margin:0.4em;height:300px;overflow:auto;background:#FFF;></div></div>';
	        }
	        var col = '#000';
	        if (status == 'function')
	        {

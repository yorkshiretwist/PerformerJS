...
el.className=cls;},disableContext:function(el){if(P.MooTools){return P.bind(el,'contextmenu',function(e){e.stop();});}},doHide:function(el,effect){if(typeof(el)!='object'){el=P.$(P.identify(el));}
